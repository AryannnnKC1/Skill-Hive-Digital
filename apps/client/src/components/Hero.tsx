    ...
    <section className="pt-32 lg:pt-40 pb-20 lg:pb-28">
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="flex flex-col items-center text-center">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-blue-700 mb-6">
          ...
          <p className="text-lg lg:text-xl text-slate-500 max-w-2xl mx-auto mt-6 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
            <Link
              to="/register"
              className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-7 py-3.5 rounded-xl transition-colors duration-200 cursor-pointer"
            >
              Take the Free Assessment
            </Link>
            <Link
              to="/careers"
              className="text-slate-600 hover:text-slate-900 font-medium px-4 py-3.5 transition-colors duration-200 cursor-pointer flex items-center justify-center gap-1"
            >
          ...
          <div className="mt-12 text-sm text-slate-400 flex flex-wrap items-center justify-center gap-2">
          ...
          <div className="mt-16 lg:mt-20 w-full max-w-3xl mx-auto">
            <div className="bg-white border border-slate-200 rounded-2xl shadow-lg p-6 text-left hover:shadow-xl transition-shadow duration-200">
              <h3 className="font-semibold text-lg text-slate-900 mb-6">Your Career Matches</h3>
              
              <div className="space-y-5">
                <div>
                  <div className="flex justify-between text-sm font-medium mb-2">
                    <span className="text-slate-700">Software Engineering</span>
