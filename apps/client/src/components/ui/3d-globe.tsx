  ...
  return (
    <group visible={isVisible}>
      ...
      <mesh position={surfacePosition} quaternion={lineQuaternion}>
        ...
        <meshBasicMaterial color={hovered ? "#059669" : "#0f766e"} />
      </mesh>
      ...
      <group ref={imageGroupRef} position={topPosition}>
        ...
        >
          <div
            className={cn(
              "cursor-pointer overflow-hidden rounded-full bg-neutral-900 shadow-lg transition-transform duration-200 ring-2 ring-accent/30",
              hovered && "scale-125 shadow-xl ring-accent-light/60",
            )}
            style={{
              width: "8px",
              height: "8px",
  ...
  return (
    <>
      ...
      <directionalLight
        ...
        intensity={config.pointLightIntensity * 0.55}
        color="#14b8a6"
      />
  ...
  return (
    <Html center>
      <div className="flex shrink-0 flex-col items-center gap-3">
        <span className="inline-block shrink-0 text-sm text-ink-subtle">
          Loading globe...
        </span>
      </div>
    </Html>
